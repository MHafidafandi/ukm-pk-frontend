            ...
            {isFetching && contents.length === 0 ? (
              ...
              filteredContents.map((content) => {
                ...
                return (
                  <div
                    key={content.id}
                    className={`bg-surface-container-lowest rounded-2xl overflow-hidden hover:shadow-md transition-all group border ${
                      !isActive ? "opacity-70 border-dashed border-outline-variant/30" : "border-outline-variant/10"
                    }`}
                  >
                      ...
                      <div className="flex-1 p-5 flex flex-col justify-between min-w-0">
                        <div>
                          <div className="flex items-center gap-2 mb-2 flex-wrap">
                            ...
                            <span
                              className={`shrink-0 px-2.5 py-0.5 rounded-full text-[10px] font-black tracking-wider ${
                                isActive
